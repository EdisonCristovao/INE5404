...
public class JUnitRealizaSerializaçaoFachadaCartorioEleitoral {
	...
	@Test
	public void tentarSerializar() throws IOException {
		...
		s1.salvaFachada(cartorio, "arquivo");
			
	}

	@Test
	public void tentarDeserializar() throws Exception {

		cartorio = s1.carregaFachada("arquivo");
		
	System.out.println(cartorio.getNumDePartidos());			
	}
